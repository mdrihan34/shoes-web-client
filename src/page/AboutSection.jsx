    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left px-4">
          ...
          >
            Welcome to <span className="text-orange-500">SoleSphere</span>
          </h1>
          <p
            ref={(el) => (paragraphRefs.current[0] = el)}
            className="text-lg md:text-xl text-gray-600 mb-6 leading-relaxed"
          >
            At <strong>SoleSphere</strong>, we believe that footwear is more than just a necessity; it’s an expression of your style and comfort. 
          ...
          <p
            ...
            className="text-lg md:text-xl text-gray-600 mb-6 leading-relaxed"
          >
            As a trusted platform for footwear enthusiasts, <strong>SoleSphere</strong> brings together the best brands and latest trends. Our mission 
